...
const NavBar: React.FC = () => {
  // REMOVED: The state and animation controls for the on-scroll effect
  // const controls = useAnimation();
  // const [prevY, setPrevY] = useState(0);
  const [open,  setOpen] = useState(false);

  // REMOVED: The entire useEffect for sliding the nav away on scroll
  ...
  return (
    <>
      {/* The 'motion' wrapper is kept, but animation props are removed */}
      <motion.nav
